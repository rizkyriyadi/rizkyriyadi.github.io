...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        const {
            weather,
            dt: dateUnix,
            sys: { sunrise: sunriseUnixUTC, sunset: sunsetUnixUTX },
                                ...
                                <div class="wrapper">
                                    ...
                                    <ul class="card-list">
                                        <li class="card-item">
                                            ...
                                            <p class="label-1">PM<sub class="sub">2.5</sub></p>
                                        </li>
                                        <li class="card-item">
                                            <p class="title-1">${so2.toPrecision(3)}</p>
                                            <p class="label-1">SO<sub class="sub">2</sub></p>
                                        </li>
                                        <li class="card-item">
                                            <p class="title-1">${no2.toPrecision(3)}</p>
                                            <p class="label-1">NO<sub class="sub">2</sub></p>
                                        </li>
                                        <li class="card-item">
                                            <p class="title-1">${o3.toPrecision(3)}</p>
                                            <p class="label-1">O<sub class="sub">3</sub></p>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="card card-sm highlight-card two">
                                ...
                                <div class="card-list">
                                    ...
                                    <div>
                                        ...
                                        <p class="title-1">${module.getTime(sunsetUnixUTX, timezone)}</p>
                                    </div>
                                    </div>
                                </div>
                            </div>
